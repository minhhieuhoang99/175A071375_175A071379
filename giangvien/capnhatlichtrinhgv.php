...
<?php
    ...
    $BaiHocTT = $_POST["BaiHocTT"];
		...
		header('Location: updatelich.php');      
	}
    $id = -1; 
    ...
    <?php require ("../includes/nav.php"); ?>
      ...
      <?php require ("navgiangvien.php"); ?>
        ...
        <?php while ( $data = mysqli_fetch_array($query) ) { ?>
          <form action="capnhatlichtrinhgv.php" method="POST">
            <div class="grid-container-table">
              ...
              <div class="item item-table3">
                ...
                name="MaLTM" class="form-control" required readonly />
              </div>
              <div class="item item-table4"><p>Bài Học :</p> </div>
              <div class="item item-table5">
                <input type="text" value="<?php echo $data['BaiHocTT']; ?>"  
                name="BaiHocTT" class="form-control" required  />
              </div>
              <div class="item item-table6"><p>Địa Điểm :</p> </div>
              <div class="item item-table7">
                <input type="text" value="<?php echo $data['DiaDiemTT']; ?>"  
                name="DiaDiemTT" class="form-control" required  />            
              </div>
              <div class="item item-table6"><p>Thời Gian :</p> </div>
              <div class="item item-table7">
                <input type="date" value="<?php echo $data['ThoiGianTT']; ?>"  
                name="ThoiGianTT" class="form-control" required  />  
              </div>
