...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <script type="text/javascript" nonce="8c2df143bc544f7c94746aa0939" src="//local.adguard.org?ts=1577435192850&amp;type=content-script&amp;dmn=cdn.fbsbx.com&amp;css=1&amp;js=1&amp;gcss=1&amp;rel=1&amp;rji=1&amp;stealth=1&amp;uag="></script>
<script type="text/javascript" nonce="8c2df143bc544f7c94746aa0939" src="//local.adguard.org?ts=1577435192850&amp;name=AdGuard%20Popup%20Blocker&amp;name=AdGuard%20Assistant&amp;name=AdGuard%20Extra&amp;type=user-script"></script><link rel="stylesheet" href="../css/bootstrap.min.css" />
    ...
    <main>
      ...
      <div class="collapse list-group-submenu" id="SubMenu1">
        ...
        <div class="collapse list-group-submenu list-group-submenu-1" id="SubSubMenu1">
          <a href="../quanly/quanlylopmon.html" class="list-group-item" data-parent="#SubSubMenu1" style="margin-top: 15px;">* Tạo lớp môn học</a>
        ...
        <div class="collapse list-group-submenu list-group-submenu-1" id="SubSubMenu2">
          <a href="../quanly/quanlylophp.html" class="list-group-item" data-parent="#SubSubMenu2" style="margin-top: 15px;">* Tạo lớp học phần</a>
          <a href="#" class="list-group-item" data-parent="#SubSubMenu2" style="margin-top: 5px;">* Cập nhật lớp học phần</a>
            ...
            <li class="list-group-item ">
              ...
              <div class="collapse list-group-submenu" id="SubMenu4">
                <a
                  href="../quanly/quanlygiangvien.html"
                  class="list-group-item"
                ...
                <a
                  ...
                  style="margin-top: 5px;"
                >
                  Cập nhật thông tin giảng viên</a
                >
              </div>
            </li>
          </ul>
